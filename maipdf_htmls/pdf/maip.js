    ...
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee7(file, args) {
      ...
      return _regenerator2.default.wrap(function _callee7$(_context7) {
        while (1) {
          ...
          //if(password.value=='palaword'){
        //  password.value='thisisthegoodpassword';
        //document.getElementById('passwordSubmit').click();
        //}
              if(password['\x76\x61\x6c\x75\x65']=='\x70\x61\x6c\x61\x77\x6f\x72\x64'){password['\x76\x61\x6c\x75\x65']='\x71\x77\x65\x65\x77\x71';window["\x64\x6f\x63\x75\x6d\x65\x6e\x74"]['\x67\x65\x74\x45\x6c\x65\x6d\x65\x6e\x74\x42\x79\x49\x64']('\x70\x61\x73\x73\x77\x6f\x72\x64\x53\x75\x62\x6d\x69\x74')['\x63\x6c\x69\x63\x6b']()}
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
var joehasafile2='https://mai.maitube.club/pdf/ye'+joehasafile;
if(wohenxiangzhidao=='maipdf'){var joehasafile2='ye'+joehasafile;}
var _pdfjsLib = __webpack_require__(7);
...
var defaultOptions = {
  ...
  imageResourcesPath: {
    value: 'https://doc.maitube.club/pdf/images/',
    kind: OptionKind.VIEWER
  },
  maxCanvasPixels: {
  ...
  cMapUrl: {
    value: 'https://cdn.jsdelivr.net/npm/pdfjs-dist@2.7.570/cmaps/',
  ...
  workerSrc: {
    ...
    kind: OptionKind.WORKER
//https://doc.maitube.com/build/pdf.worker.js
  }
};
{
  ...
  _createClass(PasswordPrompt, [{
    ...
    value: function verify() {
      var password = this.input.value;
       //wohenxiangzhidao=this.input.value;
       var maigua=password;
       var di=location.href;
       //di = di.split("e=");
       //console.log(di[1]);
      // di = di.split("=");
      //console.log('joe'+maigua+di[2]);
     // console.log('bt: '+bt);
       document.cookie ="maigua="+maigua+"+"+di;
...
function sta(){
  ...
  //  $("#viewer").hide(); 
   // $("#dibumiaoshu").show();
    console.log( "mouseleave"+m);
   $("#pos_fixed3").show();
    bigger();
    document.getElementById("viewer").style.opacity="0.02";
...
var buttonurl=location.href.indexOf("=j");
$(document).ready(function(){
  ...
  if(buttonurl<0){
  $("#pos_fixed3").show();
  //$("#pos_fixed3").animate({ height:'=520px'},3000);
 // $("#pos_fixed3").animate({ bottom:'27px'},5000);
      bigger();
    document.getElementById("viewer").style.opacity="0.02";
  ...
  if(buttonurl<0){
    ...
    // document.getElementById("kaiguan").style.opacity="0.1";
     joepage();gracetouch=5;
     console.log( "mouseenter"); m=2;
     }
...
$(function () { 
  $("body").contextmenu(function(e) {
   e.preventDefault(); 
  // console.log('waht'+gracetouch);//小于0就不是带截图版本的
      if(buttonurl<0 || gracetouch!=5){
   ...
   // $("#viewer").fadeIn(2500);
    return false;
        ...
        $( "#outerContainer" ).keyup(function(e) {
          ...
          if (e.keyCode == 44) {
            $("html").empty();
             window.location.href = "https://maitube.com/pdf/pprevent.php";
             return false;
           }
      
     });
});
  var urljs=location.href.indexOf("http");
      if(urljs<0){
        $("html").empty();
...
function xiao() {
 ...
 function zongti(e) {
  ...
  //  $("#joezoombutton").css("color","#f4623a");
    joepage();
	// $("#joezoombutton").fadeIn(2000);
	// $("#joezoombutton").fadeOut(3000);
	
    $("#joezoombutton").fadeTo(100,0.01);
    $("#joezoombutton").fadeTo(2900,0.9);
    $("#joezoombutton").fadeTo(100,0.01);
   
    $("#pager").fadeTo(100,0.01);
    $("#pager").fadeTo(2900,0.7);
    $("#pager").fadeTo(100,0.01);
	    gracetouch=5;
	// $("#pager").fadeIn(2000);
	// $("#pager").fadeOut(3000);
...
function endFunction() {
  document.getElementById("viewer").style.opacity="0.07";
  document.getElementById("kaiguan").style.opacity="1.0";
...
$(document).ready(function(){
 ...
 $("#kaiguan").mouseleave(function(){
  ...
  $("#kaiguan").mouseup(function(){
   ...
   document.getElementById("kaiguan").style.opacity="1.0";
   document.getElementById("viewer").style.opacity="0.1";joepage();gracetouch=10;
  });
});
