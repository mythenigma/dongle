...
<head>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            // Check if the results section is visible (form was submitted)
...
<main>    <!-- Breadcrumb Navigation -->
    ...
    <!-- Settings Section -->
    <section class="why-choose-us-section" id="section2">
        <div class="container">
            <form role="form" action="maipdftest.php" method="post">
            ...
            <div class="cta-box">
                ...
                <div class="results-grid">
                    <div class="result-box">
                        <h3 id="contact"><?php echo isset($pdflinkshort) ? $pdflinkshort : ''; ?></h3>
                        <div class="link-copy-area">
                            <input type="text" class="form-control" value="<?php echo isset($pdflinkfull) ? $pdflinkfull : ''; ?>" id="myInput">
                            <button class="btn btn-feature-start mt-3" onclick="myFunction()">Copy This Link</button>
                        </div>
                        <h5 id='Copied'></h5>
                        <h6 class="mt-3"><?php echo isset($messagebox) ? $messagebox : ''; ?></h6>                        <h5 class="mb-3">Password: "<?php $identifier2 = isset($identifier) ? 'joe'.$identifier : 'joe'; echo (strlen(isset($identifier) ? $identifier : '') < 2) ? 'To Del.MOD Link' : crypt($identifier2,'su'); ?>"</h5>
