...
<!-- Google tag (gtag.js) maipdf-->
<script async src=https://www.googletagmanager.com/gtag/js?id=G-FK2E8NPVN1></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-FK2E8NPVN1');
</script>
						...
						// 如果 upload 目录不存在该文件则将文件上传到 upload 目录下
						  ...
						  // $_SESSION["url"] = $url;
						      require_once __DIR__ . '/vendorJiami/autoload.php';
								...
								$mpdf->SetProtection(array(), 'huangmaimai', 'wofocibei');
			...
			// echo $_SESSION["url"];
             if($password<1 || $limit<1){
               ...
               document.getElementById(\"diyi\").innerHTML = 
                \"Too Short for Setting of Each Reading Period<br>Don't Joke with our IT.He's Been MAD\";</script>");
                }
		     $url = $_POST['sender'];
		     $keyurl = $_POST['sender'];
...
<script>
  ...
  <footer class="bg-light py-5">
    <div class="container">
      <div class="small text-center text-muted">Copyright &copy; 2024 - admin@maitube.com -Follow Us On FaceBook-</div>
