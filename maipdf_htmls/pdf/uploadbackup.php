      ...
      <div class="row h-100 align-items-center justify-content-center text-center">
        ...
        <div class="col-lg-8 align-self-baseline">
          <p class="text-white-75 font-weight-light mb-5">上传文件生成链接<br>功能包括不可复制和打印<br>有限的阅读次数和每次阅读的时间</p>
           <h2><a class="btn btn-primary btn-xl js-scroll-trigger" style="text-transform: none;" href="#about">开始MaiPDF</a></h2>
		  <h2>
...
var appElement = document.querySelector('div .inmodal');
    var myDropzone = new Dropzone("#dropz", {
        ...
        init:function(){
		 ...
		 header("Location: https://maipdf.com/pdf/maipdf.php");
			//设置成东八区时间
			//print_r($_FILES);
			$identifier='';
			if(!empty($_FILES) ){
  ...
  <section class="page-section" id="services">
	...
	<form   role="form" action="中华.php#contact" method="post">
      <h2 class="text-center mt-0">第二步：设置阅读次数和每次阅读的时间</h2>
	  <h5 class="text-center mb-3"  style="color:blue;">如需添加截屏保护，请选择“保护”</h5>
	  <h5 class="text-center mb-3"  style="color:blue;">截屏保护方式为一张图片挡着正文，限制鼠标移动</h5>
      <hr class="divider my-4">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
			...
			<label class="radio-inline">
					<input type="radio" name="zhangai" value="straight" checked>开放
				</label>
				<label class="radio-inline">
					<input type="radio" name="zhangai" value="obstacle">保护
				</label>
				 <h3 class="h4 mb-2">截屏防护</h3>
	...
	<?php
		if(isset ($_POST['limit']) ){
			...
			$identifier=md5($identifier);
			 ...
			 if($zhangai=='obstacle'){
			  $identifier=crypt($identifier,'jz');
			 }else{
             $identifier=crypt($identifier,'zh');
			 }
			...
			//echo "https://www.maipdf.com/pdf/?email=".$identifier;
			//echo "<a class=\"btn btn-light btn-xl\" href=\"https://www.maipdf.com/pdf/?email=".$identifier.">Click to View</a>";
			$result=mysqli_query($conn,$sql);
            $conn->close();
				 //https://item.taobao.com/item.htm?spm=a1z10.3-c-s.w4002-22366977349.15.65e44454iQRRDh&id=609902784704
		  }
		 }
		}  
	?>
		...
		<hr class="divider my-4">
		 ...
		 <input type="text" value="<?php echo "https://maipdf.com/pdf/?email=".$identifier;?>"  id="myInput" >
		  ...
		  <button class="btn btn-warning btn-xl" style="text-transform: none;" class="text-white mt-0" onclick="myFunction()">复制阅读链接</button>
			  ...
			  <h2 class="mb-4">阅读链接已生成</h2>
			 <h5 class="mb-4">阅读码：<?php	 echo  $identifier; ?></h5>
			  <h5 class="mb-4">修改码：<?php	$identifier2='joe'.$identifier; echo  crypt($identifier2,'su'); ?></h5>
			  <a class="btn btn-info btn-xl" href="https://www.maipdf.com/pdf/hahachange.php" target="_blank">修改文件</a>
			  <a class="btn btn-info btn-xl" href="<?php	echo "https://www.maipdf.com/pdf/?email=".$identifier;?>"  target="_blank">查看您的PDF</a>
              </div>
...
<script>
  ...
  <footer class="bg-light py-5">
    <div class="container">
      <div class="small text-center text-muted">Copyright &copy; 2020 - admin@maitube.com -QQ群-975121755</div>
